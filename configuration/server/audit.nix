{ ... }:
{
  ...
  security.audit = {
    ...
    rules = [
      ...
      # These do not exist at rule load time
      ...
      "-a always,exit -F arch=b64 -S mount -S mount_setattr -F auid>=1000 -F auid!=4294967295 -k mounts"
      "-a always,exit -F arch=b32 -S mount -S mount_setattr -F auid>=1000 -F auid!=4294967295 -k mounts"
      "-a always,exit -F arch=b64 -S umount2 -F auid>=1000 -F auid!=4294967295 -k mounts"
      "-a always,exit -F arch=b32 -S umount -S umount2 -F auid>=1000 -F auid!=4294967295 -k mounts"
      ...
      "-a always,exit -F arch=b64 -S execve -S execveat -F uid=0 -F auid>=1000 -F auid!=4294967295 -k actions"
      "-a always,exit -F arch=b32 -S execve -S execveat -F uid=0 -F auid>=1000 -F auid!=4294967295 -k actions"
      ...
      # Collect ptrace syscalls
      "-a always,exit -F arch=b64 -S ptrace -k debug"
      "-a always,exit -F arch=b32 -S ptrace -k debug"
    ];
  };
}
